...
class Core:
    ...
    def __init__(self, rvd, base_address):
        ...
        self._SICF3 = self._CREG_GLOB + 0x090
        self._SYL15FCP = self._CREG_GLOB + 0x090
        self._SYL14FCP = self._CREG_GLOB + 0x091
        self._SYL13FCP = self._CREG_GLOB + 0x092
        self._SYL12FCP = self._CREG_GLOB + 0x093
        self._SICF2 = self._CREG_GLOB + 0x094
        self._SYL11FCP = self._CREG_GLOB + 0x094
        self._SYL10FCP = self._CREG_GLOB + 0x095
        self._SYL9FCP = self._CREG_GLOB + 0x096
        self._SYL8FCP = self._CREG_GLOB + 0x097                                                      ## GENERATED ##
        self._SICF1 = self._CREG_GLOB + 0x098
        self._SYL7FCP = self._CREG_GLOB + 0x098
        self._SYL6FCP = self._CREG_GLOB + 0x099
        self._SYL5FCP = self._CREG_GLOB + 0x09A
        self._SYL4FCP = self._CREG_GLOB + 0x09B
        self._SICF0 = self._CREG_GLOB + 0x09C
        self._SYL3FCP = self._CREG_GLOB + 0x09C
        self._SYL2FCP = self._CREG_GLOB + 0x09D
        self._SYL1FCP = self._CREG_GLOB + 0x09E
        self._SYL0FCP = self._CREG_GLOB + 0x09F                                                      ## GENERATED ##
    ...
    FIELD_CNTH_CNT = property(
        ...
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SICF3 = property(lambda s: s._rvd.readInt(s._SICF3, 4),
        lambda s, v: raise_(RuntimeError("SICF3 is not writable")))                                  ## GENERATED ##
    FIELD_SICF3_SYL15FCP = property(
        lambda self: (self.SICF3 & 0xFF000000) >> 24,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL15FCP = property(lambda s: s._rvd.readInt(s._SYL15FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL15FCP is not writable")))
    FIELD_SICF3_SYL14FCP = property(
        lambda self: (self.SICF3 & 0x00FF0000) >> 16,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL14FCP = property(lambda s: s._rvd.readInt(s._SYL14FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL14FCP is not writable")))                               ## GENERATED ##
    FIELD_SICF3_SYL13FCP = property(
        lambda self: (self.SICF3 & 0x0000FF00) >> 8,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL13FCP = property(lambda s: s._rvd.readInt(s._SYL13FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL13FCP is not writable")))
    FIELD_SICF3_SYL12FCP = property(
        lambda self: (self.SICF3 & 0x000000FF) >> 0,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL12FCP = property(lambda s: s._rvd.readInt(s._SYL12FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL12FCP is not writable")))                               ## GENERATED ##
    SICF2 = property(lambda s: s._rvd.readInt(s._SICF2, 4),
        lambda s, v: raise_(RuntimeError("SICF2 is not writable")))
    FIELD_SICF2_SYL11FCP = property(
        lambda self: (self.SICF2 & 0xFF000000) >> 24,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL11FCP = property(lambda s: s._rvd.readInt(s._SYL11FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL11FCP is not writable")))
    FIELD_SICF2_SYL10FCP = property(
        lambda self: (self.SICF2 & 0x00FF0000) >> 16,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))                              ## GENERATED ##
    SYL10FCP = property(lambda s: s._rvd.readInt(s._SYL10FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL10FCP is not writable")))
    FIELD_SICF2_SYL9FCP = property(
        lambda self: (self.SICF2 & 0x0000FF00) >> 8,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL9FCP = property(lambda s: s._rvd.readInt(s._SYL9FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL9FCP is not writable")))
    FIELD_SICF2_SYL8FCP = property(
        lambda self: (self.SICF2 & 0x000000FF) >> 0,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))                              ## GENERATED ##
    SYL8FCP = property(lambda s: s._rvd.readInt(s._SYL8FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL8FCP is not writable")))
    SICF1 = property(lambda s: s._rvd.readInt(s._SICF1, 4),
        lambda s, v: raise_(RuntimeError("SICF1 is not writable")))
    FIELD_SICF1_SYL7FCP = property(
        lambda self: (self.SICF1 & 0xFF000000) >> 24,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL7FCP = property(lambda s: s._rvd.readInt(s._SYL7FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL7FCP is not writable")))
    FIELD_SICF1_SYL6FCP = property(                                                                  ## GENERATED ##
        lambda self: (self.SICF1 & 0x00FF0000) >> 16,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL6FCP = property(lambda s: s._rvd.readInt(s._SYL6FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL6FCP is not writable")))
    FIELD_SICF1_SYL5FCP = property(
        lambda self: (self.SICF1 & 0x0000FF00) >> 8,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL5FCP = property(lambda s: s._rvd.readInt(s._SYL5FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL5FCP is not writable")))
    FIELD_SICF1_SYL4FCP = property(                                                                  ## GENERATED ##
        lambda self: (self.SICF1 & 0x000000FF) >> 0,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL4FCP = property(lambda s: s._rvd.readInt(s._SYL4FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL4FCP is not writable")))
    SICF0 = property(lambda s: s._rvd.readInt(s._SICF0, 4),
        lambda s, v: raise_(RuntimeError("SICF0 is not writable")))
    FIELD_SICF0_SYL3FCP = property(
        lambda self: (self.SICF0 & 0xFF000000) >> 24,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL3FCP = property(lambda s: s._rvd.readInt(s._SYL3FCP, 1),                                      ## GENERATED ##
        lambda s, v: raise_(RuntimeError("SYL3FCP is not writable")))
    FIELD_SICF0_SYL2FCP = property(
        lambda self: (self.SICF0 & 0x00FF0000) >> 16,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL2FCP = property(lambda s: s._rvd.readInt(s._SYL2FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL2FCP is not writable")))
    FIELD_SICF0_SYL1FCP = property(
        lambda self: (self.SICF0 & 0x0000FF00) >> 8,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL1FCP = property(lambda s: s._rvd.readInt(s._SYL1FCP, 1),                                      ## GENERATED ##
        lambda s, v: raise_(RuntimeError("SYL1FCP is not writable")))
    FIELD_SICF0_SYL0FCP = property(
        lambda self: (self.SICF0 & 0x000000FF) >> 0,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SYL0FCP = property(lambda s: s._rvd.readInt(s._SYL0FCP, 1),
        lambda s, v: raise_(RuntimeError("SYL0FCP is not writable")))
    ...
    FIELD_GPS1_CFIC = property(
        lambda self: (self.GPS1 & 0xF0000000) >> 28,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_GPS1_CFIR = property(
        lambda self: (self.GPS1 & 0x0F000000) >> 24,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_GPS1_CIFC = property(
        lambda self: (self.GPS1 & 0x00F00000) >> 20,                                                 ## GENERATED ##
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_GPS1_CIFR = property(
        lambda self: (self.GPS1 & 0x000F0000) >> 16,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_GPS1_MPYFC = property(
        lambda self: (self.GPS1 & 0x0000F000) >> 12,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_GPS1_MPYFR = property(
        lambda self: (self.GPS1 & 0x00000F00) >> 8,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))                              ## GENERATED ##
    FIELD_GPS1_ADDFC = property(
        lambda self: (self.GPS1 & 0x000000F0) >> 4,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_GPS1_ADDFR = property(
        lambda self: (self.GPS1 & 0x0000000F) >> 0,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    ...
    FIELD_GPS0_MEMAR = property(
        lambda self: (self.GPS0 & 0x0F000000) >> 24,                                                 ## GENERATED ##
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    ...
    FIELD_GPS0_ALUR = property(
        ...
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    SPS1 = property(lambda s: s._rvd.readInt(s._SPS1, 4),                                            ## GENERATED ##
        lambda s, v: raise_(RuntimeError("SPS1 is not writable")))
    FIELD_SPS1_FCMPBRC = property(
        lambda self: (self.SPS1 & 0x0000F000) >> 12,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_SPS1_FCMPGPC = property(
        lambda self: (self.SPS1 & 0x000000F0) >> 4,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))
    FIELD_SPS1_FCMPR = property(
        lambda self: (self.SPS1 & 0x0000000F) >> 0,
        lambda self, val:raise_(RuntimeError('Cannot write to field')))                              ## GENERATED ##
