...
--=============================================================================                      -- GENERATED --
  ...
  --===========================================================================
    ...
    registerCtrlReg("CR_SICF3", 16#090#);
    registerCtrlReg("CR_SYL15FCP", 16#090#);
    registerCtrlReg("CR_SYL14FCP", 16#091#);
    registerCtrlReg("CR_SYL13FCP", 16#092#);                                                         -- GENERATED --
    registerCtrlReg("CR_SYL12FCP", 16#093#);
    registerCtrlReg("CR_SICF2", 16#094#);
    registerCtrlReg("CR_SYL11FCP", 16#094#);
    registerCtrlReg("CR_SYL10FCP", 16#095#);
    registerCtrlReg("CR_SYL9FCP", 16#096#);
    registerCtrlReg("CR_SYL8FCP", 16#097#);
    registerCtrlReg("CR_SICF1", 16#098#);
    registerCtrlReg("CR_SYL7FCP", 16#098#);
    registerCtrlReg("CR_SYL6FCP", 16#099#);
    registerCtrlReg("CR_SYL5FCP", 16#09A#);                                                          -- GENERATED --
    registerCtrlReg("CR_SYL4FCP", 16#09B#);
    registerCtrlReg("CR_SICF0", 16#09C#);
    registerCtrlReg("CR_SYL3FCP", 16#09C#);
    registerCtrlReg("CR_SYL2FCP", 16#09D#);
    registerCtrlReg("CR_SYL1FCP", 16#09E#);
    registerCtrlReg("CR_SYL0FCP", 16#09F#);
